...
define([
    ...
    'text!./templates/FocusedCWL.html',
    'text!./FocusedCWLConfig.json'
], function(
    _jQueryLayout,
    Logger,
    ComponentSettings,
    ...
    var FocusedCWL = function(params) {
        this._logger = (params && params.logger) || Logger.create('gme:Layouts:FocusedCWL',
            WebGMEGlobal.gmeConfig.client.log);
        this.config = FocusedCWL.getDefaultConfig();
        ComponentSettings.resolveWithWebGMEGlobal(this.config, FocusedCWL.getComponentId());
    ...
    FocusedCWL.getComponentId = function () {
        return 'FocusedCWL';
    };

    FocusedCWL.getDefaultConfig = function () {
        return CONFIG;
    };
     ...
     * @return {undefined}
     */
    FocusedCWL.prototype.init = function() {
        var self = this;
     ...
     * @return {undefined}
     */
    FocusedCWL.prototype.addToContainer = function(panel, container) {
        if (container === 'header') {
     ...
     * @return {undefined}
     */
    FocusedCWL.prototype.remove = function(panel) {
     ...
     * @return {undefined}
     */
    FocusedCWL.prototype.destroy = function() {
        this._body.empty();
    };
    ...
    FocusedCWL.prototype._onCenterResize = function() {
        if (this._canvas) {
            this._canvas.setSize(this._centerPanel.width(), this._centerPanel.height());
        }
    };

    FocusedCWL.prototype._onToolboxResize = function() {
        if (this._toolbox) {
